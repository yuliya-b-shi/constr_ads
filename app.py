...
st.bar_chart(df, x='Год', y=['Строительство', 'Реал_строительство'])
...
if option == 'Номинальные зарплаты':
    ...
    ''')
    st.write(
        'Рост зарплат в сфере рекламы неравномерный, в период 2013-2016 гг - пилообразный. Это можно объяснить ростом геополитической напряженности, которая негативно сказывается на предпринимательской деятельности, от активности в которой сильно зависит доходность рекламного бизнеса. Обращает на себя внимание успешные для рекламщиков 2006-2007 годы (пик на графике). Превзойти этот результат до сих пор не удалось. Можно предположить, что связано это в целом с экономическими успехами докризисного 2006 года, оптимизмом бизнеса и его желанием вкладываться в развитие.')
    st.write(
