...
st.bar_chart(df, x='Год', y=['Реал_строительство', 'Строительство'], color=["#FF0000", "#0000FF"])
st.write('_Реальные и номинальные средние зарплаты (реклама)_')
st.bar_chart(df, x='Год', y=['Рекламная деятельность', 'Реал_реклама'], color=["#FF0000", "#0000FF"])
option = st.selectbox(
    '**Выберите график**',
